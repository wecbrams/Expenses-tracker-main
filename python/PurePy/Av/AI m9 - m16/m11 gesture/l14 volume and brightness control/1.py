...
import cv2
import mediapipe as mp # Track the hand and identifies each finger's landmark
import numpy as np
from pycaw.pycaw import AudioUtilities, IAudioEndpointVolume # Control system audio
