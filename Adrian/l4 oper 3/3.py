...
markOne = int(input("Enter mark 1: "))
markTwo = int(input("Enter mark 2: "))
markThree = int(input("Enter mark 3: "))
markFour = int(input("Enter mark 4: "))
markFive = int(input("Enter mark 5: "))
